...
static buildSelectionRequest(jsonSelReq: any) : SelectionRequest {
  return new SelectionRequest(
    {authorId: jsonSelReq.authorId, authorName: jsonSelReq.authorId,
    refTweetId: jsonSelReq.refTweetId, id: jsonSelReq.id, createdAt:"", text:""},
    jsonSelReq.count, jsonSelReq.engagement, jsonSelReq.selectionTime
  );
  }
}